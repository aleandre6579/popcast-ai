...
def process_songs_in_batches(
    embeddings_filepath, song_paths, lower, upper, batch_size=10
):
...
all_bounds = [
    (lower, upper) for (lower, upper) in zip(range(28, 48, 4), range(32, 52, 4))
]
...
for bounds in all_bounds:
    ...
    songs_data_full = process_songs_in_batches(
        embeddings_filepath, song_paths, lower, upper, batch_size=125
    )
